...
namespace PostIllusions.Audio.Sequencer
{
    ...
    {
        public static event Action<Event> OnSetPlaybackState;
        ...
        public void Play()
        {
            if (OnSetPlaybackState != null) OnSetPlaybackState(Event.Play);
        }

        public void Pause()
        {
            if (OnSetPlaybackState != null) OnSetPlaybackState(Event.Pause);
        }

        public void Stop()
        {
            if (OnSetPlaybackState != null) OnSetPlaybackState(Event.Stop);
        }
    }
}
